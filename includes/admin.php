...
?>
	<div class="wrap">
		...
		<ol>
			...
			<li>Disable the user sitemap to prevent the leakage of usernames.</li>
			...
			<li>Add output escaping to the_title to prevent XSS.</li>
		</ol>
		...
		<ol>
			...
			<li>Replace a comment's e-mail address with "comment-ID@example.com when the comment is approved or classified as spam.</li>
